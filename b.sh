...
#
#git clone https://github.com/shamith16/gcc-linaro-6.4.1 toolchain
make clean 
make mrproper
VERSION="Oreo"
DEVICE="Kenzo"
...
cd $KERNEL_DIR
export ARCH=arm64
export CROSS_COMPILE="/home/amoghmaiya/lin/bin/aarch64-linux-gnu-"
...
End=$(date +"%s")
Diff=$(($End - $Start))
echo -e "$yellow $KERNEL_DIR/build/$VERSION/shadow-$DEVICE-$VERSION-$date.zip \n$white"
